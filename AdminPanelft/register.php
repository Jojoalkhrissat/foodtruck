...
$addshop= 'INSERT INTO `shop`( `shopname`, `shopnamear`, `firstname`, `lastname`, `phonenumber`, `email`,  `opentime`, `closetime`, `city`, `location`, `monthlypayment`, `active`, `isnew`, `address`) VALUES ( "'.$shopname.'", "'.$shopnamear.'","'.$shopownerFN.'", "'.$shopownerLN.'", "'.$shopnumber.'", "'.$email.'", "'.$opentime.'", "'.$closetime.'", "'.$city.'", "'.$shoplat.','.$shoplong.'", "0.1", 0, 1, "'.$address.'") ';
