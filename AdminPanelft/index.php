                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
                                         ...
                                         <a href="ordersbyyear?startdate=<?php echo $year?>&enddate=<?php echo $year?>"> <div class="h5 mb-0 font-weight-bold text-gray-800">$<?php echo $yearlyon[0];?></div>
                                       </a>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                              Earnings (online)</div>
                                           <a href="ordersbydate?startdate=<?php echo $startdate?>&enddate=<?php echo $enddate?>"> <div class="h5 mb-0 font-weight-bold text-gray-800">$<?php echo $saleson[0];?></div>
                                         </a>
                                        </div>
