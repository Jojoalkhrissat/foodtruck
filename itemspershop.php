...
if ($_SERVER["REQUEST_METHOD"] == "GET"){
	...
	try{
		if($customerid==""){
$MyJsonData1="";
$itemspershop="SELECT I."."id, I.Name,'' as IsFavorite,I.Description, I.SubCategory,SU.Name, I.Photo,I.Photo1,I.Photo2, I.Price, I.TimesSold,avg(F.Rating) as Rating,count(F.Rating) as RatingNumber FROM items I left join feedback F on F.ItemId=I.id  left join shop S on I.Shop=S.id left join subcategory SU on I.SubCategory=SU.id and F.ItemId=I.id where I.Shop=$shop GROUP By i.id";
